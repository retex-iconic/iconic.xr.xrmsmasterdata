...
@Api(value = "Fornitore Commands", description = "Fornitore Commands Related Endpoints", tags = "Fornitore Commands")
public class FornitoreCommandsController {
    ...
    @PostMapping
    public CompletableFuture<Object> createFornitore(@RequestBody FornitoreCreateDTO fornitoreCreateDTO) {
    ...
    public FornitoreAggregate getFornitoreAggregate(@PathParam(value = "fornitoreId") String fornitoreId) {
    ...
    public CompletableFuture<String> addedArticolo(@PathParam(value = "fornitoreId") String fornitoreId,
                                                    @RequestBody FornitoreAddArticoloDTO fornitoreAddArticoloDTO) {
        CompletableFuture<String> res = fornitoreCommandService.addedArticolo(fornitoreId, fornitoreAddArticoloDTO);
        return res;
    }

    @PutMapping("/articoloFornitorePrincipaleIndex/{fornitoreId}")
    public CompletableFuture<String> articoloIndex(@PathParam(value = "fornitoreId") String fornitoreId,
                                                    @RequestBody FornitoreArticoloIndexDTO fornitoreArticoloIndexDTO) {
        CompletableFuture<String> res = fornitoreCommandService.articoloIndex(fornitoreId, fornitoreArticoloIndexDTO);
        return res;
    }
}